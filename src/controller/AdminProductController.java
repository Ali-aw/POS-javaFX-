...
public class AdminProductController {
	...
	void initialize() throws ClassNotFoundException, SQLException, InstantiationException, IllegalAccessException {
		assert tb_product_item != null
				: "fx:id=\"tb_product_item\" was not injected: check your FXML file 'admin_product.fxml'.";
		...
		assert tf_date_added != null
				: "fx:id=\"tf_date_added\" was not injected: check your FXML file 'admin_product.fxml'.";
		assert tf_stock != null : "fx:id=\"tf_stock\" was not injected: check your FXML file 'admin_product.fxml'.";
		assert tf_expired_date != null
				: "fx:id=\"tf_expired_date\" was not injected: check your FXML file 'admin_product.fxml'.";
		...
		assert cbo_category != null
				: "fx:id=\"cbo_category\" was not injected: check your FXML file 'admin_product.fxml'.";
		assert cbo_supplier != null
				: "fx:id=\"cbo_supplier\" was not injected: check your FXML file 'admin_product.fxml'.";
		assert bt_new != null : "fx:id=\"bt_new\" was not injected: check your FXML file 'admin_product.fxml'.";
		assert tf_name_search != null
				: "fx:id=\"tf_name_search\" was not injected: check your FXML file 'admin_product.fxml'.";
		assert tf_barcode_search != null
				: "fx:id=\"tf_barcode_search\" was not injected: check your FXML file 'admin_product.fxml'.";
	...
	void onbtAddAction(ActionEvent event)
		...
		if (tf_barcode.getText().toString().equals("") || tf_name.getText().toString().equals("")
			...
			try {
				// get category id by name
				String categoryQuery = "SELECT `id` FROM `productcategory` WHERE productcategory.name = '"
						+ categoryname
						+ "'";
				int categoryid = 0;
				new DBInitialize().DBInitialize();
				...
				String upquery = "UPDATE `supplier` SET `lastdatesupplied`='" + todaydate + "' WHERE `id`='"
						+ supplierid
						+ "'";
