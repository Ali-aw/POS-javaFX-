...
public class AdminCashierController {
	...
	void initialize() throws ClassNotFoundException, SQLException, InstantiationException, IllegalAccessException {
		...
		assert bt_cashier_add != null
				: "fx:id=\"bt_cashier_add\" was not injected: check your FXML file 'Admin_cashier.fxml'.";
		assert bt_cashier_update != null
				: "fx:id=\"bt_cashier_update\" was not injected: check your FXML file 'Admin_cashier.fxml'.";
		...
		assert tf_password != null
				: "fx:id=\"tf_password\" was not injected: check your FXML file 'Admin_cashier.fxml'.";
		assert tf_date_created != null
				: "fx:id=\"tf_date_created\" was not injected: check your FXML file 'Admin_cashier.fxml'.";
		...
		tb_cashier.getColumns().addAll(col_item_id, col_item_name, col_item_age, col_item_gender, col_item_addr,
				col_item_phone, col_item_email, col_item_password, col_item_date_created);
		...
		tb_cashier.setRowFactory(t -> {
			...
			removeItem.setOnAction(new EventHandler<ActionEvent>() {
				...
				public void handle(ActionEvent event) {
					...
					Alert alert = new Alert(AlertType.CONFIRMATION, "Are U Sure To Delete " + ca.getName() + " ?",
	...
	void onBtAddAction(ActionEvent event) throws SQLException {
		...
		if (tf_name.getText().equals("") || tf_id.getText().equals("") || tf_age.getText().equals("")
				|| tf_addr.getText().equals("") || tf_phone.getText().equals("") || tf_email.getText().equals("")
				|| tf_password.getText().equals("")
				|| tf_date_created.getText().equals("") || tf_age.getText().matches(".*[a-zA-Z]+.*")
				|| Integer.parseInt(tf_age.getText()) < 18 || tf_phone.getText().matches(".*[a-zA-Z]+.*")
				|| tf_phone.getText().length() < 9 || !tf_email.getText().contains("mail.com")
			...
			try {
				String addQuery = "INSERT INTO `cashier` (`id`, `name`, `age`, `gender`, `address`, `phone`, `email`, `password`, `date created`) VALUES ( "
						+ id + ", '" + name + "', " + age + ", '" + gender + "','" + addr + "','" + ph + "','" + mail
						+ "','" + pw + "','" + datecreated + "')";
				new DBInitialize();
	...
	void onbtUpdateAction(ActionEvent event) throws SQLException {
		...
		if (tf_name.getText().equals("") || tf_id.getText().equals("") || tf_age.getText().equals("")
			...
			String updateQuery = "UPDATE `cashier` SET `name`='" + name + "',`age`='" + age + "',`gender`='" + gender
					+ "',"
					+ "`address`='" + addr + "',`phone`='" + ph + "',`email`='" + mail + "',`password`='" + pw
					+ "',`date created`='" + datecreated + "' WHERE `id`= " + id + ";";
			new DBInitialize();
