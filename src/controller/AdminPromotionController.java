...
public class AdminPromotionController {
	...
	void initialize() throws ClassNotFoundException, SQLException, InstantiationException, IllegalAccessException {
		...
		assert tf_product_id != null
				: "fx:id=\"tf_product_id\" was not injected: check your FXML file 'Admin_promotion.fxml'.";
		assert tf_percentage != null
				: "fx:id=\"tf_percentage\" was not injected: check your FXML file 'Admin_promotion.fxml'.";
		...
		assert tf_product_name != null
				: "fx:id=\"tf_product_name\" was not injected: check your FXML file 'Admin_promotion.fxml'.";
