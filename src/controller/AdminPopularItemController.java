...
public class AdminPopularItemController {
    ...
    void initialize() throws ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException {
        assert tb_popular != null
                : "fx:id=\"tb_popular\" was not injected: check your FXML file 'Admin_popular_item.fxml'.";
        ...
        tb_popular.getColumns().addAll(col_item_barcode, col_item_name, col_item_categroy, col_item_price,
                col_item_supplier, col_item_dateadded, col_item_stock, col_item_expire_date, col_item_count);
