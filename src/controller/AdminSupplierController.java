...
public class AdminSupplierController {
	...
	void initialize() throws ClassNotFoundException, SQLException, InstantiationException, IllegalAccessException {
		assert tb_supplier != null
				: "fx:id=\"tb_supplier\" was not injected: check your FXML file 'Admin_supplier.fxml'.";
		...
		assert tf_supplied_date != null
				: "fx:id=\"tf_supplied_date\" was not injected: check your FXML file 'Admin_supplier.fxml'.";
		...
		tb_supplier.setRowFactory(t -> {
			...
			removeItem.setOnAction(new EventHandler<ActionEvent>() {
				...
				public void handle(ActionEvent event) {
					...
					Alert alert = new Alert(AlertType.CONFIRMATION, "Are U Sure To Delete " + su.getName() + " ?",
					...
					if (alert.getResult() == ButtonType.YES) {
						...
						// get count
						int cateCount = 0;
						String getSupplierUsedCount = "SELECT COUNT(*) FROM productitems, supplier WHERE supplier.id = productitems.supplierid AND supplier.id = '"
								+ su.getId() + "'";
						try {
							new DBInitialize().DBInitialize();
							new DBInitialize();
						...
						if (cateCount > 0) {
							...
							Alert aal = new Alert(AlertType.ERROR,
									"Cannot Delete! This Supplier has been used in product items. You can delete the product items that link with this category and try again. Thanks!");
							aal.showAndWait();
	...
	void onAddAction(ActionEvent event)
		...
		if (tf_id.getText().equals("") || tf_name.getText().equals("") || tf_supplied_date.getText().equals("")
				|| tf_supplied_date.getText().length() < 10) {
			...
			try {
				String addquery = "INSERT INTO `supplier`(`id`, `companyname`, `lastdatesupplied`) VALUES (" + id + ",'"
						+ name + "','" + lastsupplied + "');";
	...
	void onUpdateAction(ActionEvent event)
		...
		if (tf_id.getText().equals("") || tf_name.getText().equals("") || tf_supplied_date.getText().equals("")
			...
			String upquery = "UPDATE `supplier` SET `companyname`='" + name + "',`lastdatesupplied`='" + lastsupplied
					+ "' WHERE `id`='" + id + "'";
