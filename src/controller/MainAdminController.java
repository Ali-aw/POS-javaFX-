...
public class MainAdminController {
	...
	void initialize() {
		...
		assert bt_promotion != null
				: "fx:id=\"bt_promotion\" was not injected: check your FXML file 'Admin_panel.fxml'.";
	...
	void onPopularAction(ActionEvent event) {
		...
		System.out.println("ba3ed l catch");
		common_pane.getChildren().clear();
		System.out.println("ba3ed l clear");

		common_pane.getChildren().add(pane);
		System.out.println("ba3ed l addd pane");
