...
public class AdminCustomerController {
	...
	void initialize() throws ClassNotFoundException, SQLException, InstantiationException, IllegalAccessException {
		assert tb_customer != null
				: "fx:id=\"tb_customer\" was not injected: check your FXML file 'Admin_customer.fxml'.";
		...
		assert tf_card_no != null
				: "fx:id=\"tf_card_no\" was not injected: check your FXML file 'Admin_customer.fxml'.";
		assert tf_amount != null : "fx:id=\"tf_amount\" was not injected: check your FXML file 'Admin_customer.fxml'.";
		assert tf_last_date_used != null
				: "fx:id=\"tf_last_date_used\" was not injected: check your FXML file 'Admin_customer.fxml'.";
		assert tf_pin != null : "fx:id=\"tf_pin\" was not injected: check your FXML file 'Admin_customer.fxml'.";
		assert tf_date_created != null
				: "fx:id=\"tf_date_created\" was not injected: check your FXML file 'Admin_customer.fxml'.";
		...
		assert rdo_female != null
				: "fx:id=\"rdo_female\" was not injected: check your FXML file 'Admin_customer.fxml'.";
		...
		assert tf_expired_date != null
				: "fx:id=\"tf_expired_date\" was not injected: check your FXML file 'Admin_customer.fxml'.";
			...
			removeItem.setOnAction(new EventHandler<ActionEvent>() {
				...
				public void handle(ActionEvent event) {
					...
					Alert alert = new Alert(AlertType.CONFIRMATION,
							"Are U Sure You Want To Delete " + ca.getName() + " from database including card ?",
							ButtonType.YES,
							ButtonType.NO);
					alert.showAndWait();
